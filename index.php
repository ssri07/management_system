...
<meta http-equiv="Cache-control" content="public">
	...
	<style>
       .container-login100::before {
          background: -webkit-linear-gradient(right, rgba(0,168,255,0.5), rgba(185,0,255,0.5));
          background: -o-linear-gradient(right, rgba(0,168,255,0.5), rgba(185,0,255,0.5));
          background: -moz-linear-gradient(right, rgba(0,168,255,0.5), rgba(185,0,255,0.5));
          background: linear-gradient(right, rgba(0,168,255,0.5), rgba(185,0,255,0.5));
          pointer-events: none;
        }
	</style>	
    </head>
